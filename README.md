...
**Median Haharu L7 NDVI ** is the GEE script to create median NDVI values at the Haharu district scale, using the Haharu shapefile that has been shared here. We downloaded NDVI data from GEE as a .csv file.
